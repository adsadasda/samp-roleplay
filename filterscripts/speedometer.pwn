...
public OnPlayerConnect(playerid)
{
	...
	cWspeedo[playerid][7] = CreatePlayerTextDraw(playerid, 572.509460, 407.528869, "PALIWO");
	...
	cWspeedo[playerid][9] = CreatePlayerTextDraw(playerid, 618.444335, 406.533325, "STAN");
...
//-----------------------------------------------------------------------------//
CMD:zmienpredkosc(playerid, params[])
{
	#pragma unused params
	if(PlayerSpeedo[playerid] == 0)
	{
        PlayerSpeedo[playerid] = 1;
        SendClientMessage(playerid, -1, "Twoj¹ prêdkoœæ zmienono na MP/H");
	}
	else
	{
        PlayerSpeedo[playerid] = 0;
		SendClientMessage(playerid, -1, "Twoj¹ prêdkoœæ zmienono na KM/H");
	}
	return 1;
}
